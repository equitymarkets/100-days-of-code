...
#Sphere and Arrow__________________________
...
ax.quiver(-9.0, -8, -2.5, 3, 1, 2)
x = -9
y = -9
z = -2.1
ax.scatter(x, y, z, c = 'darkviolet')
plt.show()
...
# ~ ax.annotate("", xy=(5, 2), xytext=(0, 0), arrowprops=dict(arrowstyle="->"))
# ~ x = np.zeros(10)
# ~ y = np.zeros(10)
# ~ z = np.arange(10)
# ~ dx = np.zeros(10)
