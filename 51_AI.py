...
# ~ dec_event = int(input("Please define a percentage value of the decision event."))
...
# ~ for e in range(0,100):
    ...
    # ~ else:
        # ~ z = (x/100)
        # ~ print("Miss: Rational decision not processed! " + str(z))
    
# ~ print("\nYour total sum is " + sumval)
# ~ print("Your average probability is " + (sumval/100))
